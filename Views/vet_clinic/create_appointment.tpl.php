        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                ...
                <?php foreach ($clinics as $clinic): ?>
                    ...
                    <div class="mb-3">
                        <a href="/clinic/admin/vet-clinic/<?= htmlspecialchars($clinic->id) ?>" class="btn btn-outline-secondary btn-sm text-decoration-none">
                            <i class="bi bi-arrow-left"></i> Назад к клинике
                        </a>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="/clinic/admin/appointment/create/clinic/<?= htmlspecialchars($clinic->id) ?>" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="vet_id" class="form-select" id="doctorSelect" required>
                                        <option value="" selected disabled>Выберите врача из списка...</option>

                                        <?php if (!empty($clinic->vet) && is_array($clinic->vet)): ?>
                                            <?php foreach ($clinic->vet as $vet): ?>
